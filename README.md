...
This konnector retrieves your life insurance assets from [Nalo](https://nalo.fr/).
...
The Nalo konnector is developed by [dohseven](https://github.com/dohseven) and distributed under the [AGPL v3 license][agpl-3.0].
